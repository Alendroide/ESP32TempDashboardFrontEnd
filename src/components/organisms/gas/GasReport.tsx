...
const GasReport = forwardRef<HTMLDivElement, ReportCardProps>(({ average, min, max, from, to }, ref) => {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-800">
            📊 Informe de Concentración de CO₂
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-100 text-blue-800 rounded-xl p-4 shadow-sm flex flex-col items-center">
            ...
            <span className="text-3xl font-bold">{average.toFixed(2)} ppm</span>
          </div>
          <div className="bg-green-100 text-green-800 rounded-xl p-4 shadow-sm flex flex-col items-center">
            ...
            <span className="text-3xl font-bold">{min.toFixed(2)} ppm</span>
          </div>
          <div className="bg-red-100 text-red-800 rounded-xl p-4 shadow-sm flex flex-col items-center">
            ...
            <span className="text-3xl font-bold">{max.toFixed(2)} ppm</span>
          </div>
        </div>
      </div>

      <div className="absolute bottom-6 right-6 flex gap-2 items-center">
        <img src="/logosena.png" alt="logo sena" className="w-12 h-12" />
      </div>
    </div>
  );
});
